...
public final class HkUtils {
     ...
     * @return {@link Thread}
     */
    public static void rtspToFlv(String rtspUrl, AsyncContext context, Integer imageWidth, Integer imageHeight) {
        ThreadPoolTaskExecutor taskExecutor = SpringContextHolder.getBean("converterPoolExecutor");
        FlvConverter converter = new FlvConverter(rtspUrl, context, imageWidth, imageHeight);
        taskExecutor.submit(converter);
    }
     ...
     * @return {@link Thread}
     */
    public static void rtspToFlv(String rtspUrl, AsyncContext context, Integer imageWidth, Integer imageHeight, String bufferSize) {
        ThreadPoolTaskExecutor taskExecutor = SpringContextHolder.getBean("converterPoolExecutor");
        FlvConverter converter = new FlvConverter(rtspUrl, context, imageWidth, imageHeight, bufferSize);
        taskExecutor.submit(converter);
    }
